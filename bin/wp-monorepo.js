...
if (
  ...
  console.log(
    "  - WordPress root directory: Initializes monorepo in existing WordPress",
  );
  console.log(
    "  - Empty directory: Creates new WordPress + monorepo structure",
  );
  console.log("");
  console.log("Examples:");
  console.log(
    "  wp-monorepo setup              # Initialize monorepo structure",
  );
...
if (command === "setup") {
  ...
  try {
    ...
    if (subCommand === "theme" || subCommand === "plugin") {
      execSync(
        `node ${path.join(__dirname, "..", "scripts", setupScript + ".js")}`,
        {
          stdio: "inherit",
          cwd: cwd,
        },
    ...
    if (isWordPressInstallation(cwd)) {
      ...
      console.log(
        "WordPress installation detected. Setting up monorepo structure...",
      );
      execSync(
        `node ${path.join(__dirname, "..", "scripts", setupScript + ".js")} ${cwd}`,
        {
          stdio: "inherit",
        },
      );
